...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="mx-10 mt-[13%] sm:mt-[20%] flex flex-col gap-4 font-semibold">
      ...
      <p className="hidden sm:block sm:w-1/2 md:w-1/3 text-white">{overview}</p>
      <div className="flex gap-5">
        ...
        <button className="hidden md:flex gap-2 items-center bg-gray-500 bg-opacity-60 py-1 text-white  px-3 rounded-sm">
